...
using SGHitSingleCallbackFn = jc::Action<HitInfo&>;
using SGHitMultiCallbackFn = jc::Action<SGHitInfoList&, int>;
...
private:
	...
	jc::Event<HitInfo&> singleHitEvent_;
	jc::Event<SGHitInfoList&, int> multiHitEvent_;
	jc::Vector<HitInfo> hitPossibleList_;
	jc::HashMap<Actor*, Actor*> alreadyHitEnemy_;
