...
#include "Game/Contents/ActionMgr.h"

#include "sgcl/Game/Action/SGAction.h"
#include "sg/Util/DescLoaderMgr.h"
#include "sgcl/Game/Action/AllActions.h"
...
{
	jc_assert_msg(actionMap_.Exist(_actionCode), "해당 코드값의 액션이 존재하지 않습니다.");
...
{
	jc_assert_msg(baseAction_[_baseActionType], "해당 기초액션이 아직 구현되지 않았습니다.");
