...
void GameInterServerClientNetGroup::InitializeInterServerTcp()
{
	...
	pInterServerClient->Bind(sg::GameServerProcessInfo->bindInterServerTcp_);
...
void GameInterServerClientNetGroup::InitializeInterServerUdp()
{
	...
	pInterServerClient->Bind(sg::GameServerProcessInfo->bindInterServerUdp_);
...
//////////////////////////////////////////////////////////////////////////////////////////
void GameInterServerClientNetGroup::OnUpdate(const jc::TimeSpan& _elapsed)
{
}
