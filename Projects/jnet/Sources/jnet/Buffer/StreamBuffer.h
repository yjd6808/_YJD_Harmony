...
public:
	...
	StreamBuffer(char* _pBuffer, int _bufferSize)
	: buffer_(_pBuffer)
	, readPos_(0)
	, writePos_(0)
	...
	WSABUF GetReadableBuffer()
	{
		return { (_u32)writePos_ - readPos_, buffer_ + readPos_ };
	}
...
using StreamBufferPtr = jc::SharedPtr<StreamBuffer>;
