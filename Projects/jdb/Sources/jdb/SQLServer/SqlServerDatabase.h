...
public:
	...
	IQueryPtr            QueryOnConnection(SqlServerConnection* _pConn, const BoundStmt& _stmt);

protected:
	IQueryPtr	CreateQuery(IConnection* _pConn, const BoundStmt& _stmt) const override;
