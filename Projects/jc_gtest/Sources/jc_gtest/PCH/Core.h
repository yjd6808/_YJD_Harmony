...
#define SyncTestEnabled             ON      // jc::Sync 테스트 수행 여부
#define ThreadingTest               ON      // jc::Threading 테스트 수행 여부
#define WrapperTest                 ON      // jc::Wrapper 테스트 수행 여부
...
// 개별 테스트 수행시 사용
	...
	#define	TEST_StaticStringTest			ON
		...
		#define TEST_CMessageTest					ON
        #define TEST_HashMapTest                    ON
		#define TEST_HashSetTest                    ON
		#define TEST_DataMapTest                    ON
		#define TEST_TreeMapTest                    ON
		#define TEST_TreeSetTest                    ON
...
#if Print == ON
	printf(fmt, jc::Forward<Args>(args)...);
#endif
}
