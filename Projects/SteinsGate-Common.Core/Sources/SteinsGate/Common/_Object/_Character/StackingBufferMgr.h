...
{
public:
	void Add(Int32U _id, Int32U _type, float _deltaPerSec, Int32U _duration, bool _isPercentStacking = false, float _percentBase = 0.f);
	...
	void ResetDirtyAll();
private:
	JCore::HashMap<Int32U, CStackingBuffer>	map_;
};
