...
#define BATTLE_PLAYWAIT_TIME		7000	// RoomState가 PlayWait 상태로 얼마나 둘지 - 즉 이 시간동안 다른 플레이어가 로딩할때까지 실제 게임을 진행하지 않고 기다려준다.
#define BATTLE_PLAYING_TIME			60000	// 이 시간동안 게임을 진행한다.
#define BATTLE_ENDWAIT_TIME			10000	// 이 시간동안 게임을 하면서 플레이어가 기록한 통계 수치를 보여준다. 이시간이 만료되면 배틀이 끝난것으로 보고 모든 플레이어를 방으로 이동시킨다.
