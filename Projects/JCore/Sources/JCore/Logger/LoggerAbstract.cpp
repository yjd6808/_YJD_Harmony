...
////////////////////////////////////////////////////////////////////////////////////////////////////////
void LoggerAbstract::LogPlain(const JCore::String& _str)
{
...
void LoggerAbstract::SetHeaderFormat(const String& _fmt)
{
	...
	{
		DebugAssertMsg(levelIndex != -1, "헤더에 레벨 태그가 없습니다.");
	}

	if (m_pOption->ShowDateTime)
	{
		DebugAssertMsg(dateTimeIndex != -1, "헤더에 데이트타임 태그가 없습니다.");
	}
...
String LoggerAbstract::CreateHeader(Level _level)
{
	...
	DebugAssertMsg(m_pOption->ShowLevel && levelIndex != -1, "헤더에 레벨 태그가 없습니다.");
	DebugAssertMsg(m_pOption->ShowDateTime && dateTimeIndex != -1, "헤더에 데이트타임 태그가 없습니다.");
