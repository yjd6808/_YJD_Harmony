...
//////////////////////////////////////////////////////////////////////////////////////////
int Global::convertAvatarPartNameToType(const SGString& _avatarPartName)
{
	return -1;
}
...
//////////////////////////////////////////////////////////////////////////////////////////
const SGString& Global::getAvatarSgaName(int _charType, int _avatarType)
{
	DebugAssertMsg(_charType >= CharType::Begin && _charType >= CharType::End, "올바르지 않은 캐릭터 타입입니다. [1]");
	DebugAssertMsg(_avatarType >= AvatarType::Begin && _avatarType < AvatarType::Max, "올바르지 않은 비주얼 아바타 타입입니다.");
	return avatarPackName_[_charType][_avatarType];
}

//////////////////////////////////////////////////////////////////////////////////////////
const SGString& Global::getWeaponSgaName(int _weaponType)
{
	DebugAssertMsg(_weaponType >= WeaponType::Begin && _weaponType < WeaponType::Max, "올바르지 않은 비주얼 아바타 타입입니다.");
...
SpriteFrameTexture* Global::getDefaultFrameTexture()
{
	...
	pDefaultTexture->initWithData(white2x2TextureData, sizeof(white2x2TextureData), SGTexture::PixelFormat::RGB888, 2,
	                              2, { 2, 2 });
