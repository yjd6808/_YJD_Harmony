...
void ImagePack::ReleaseFrameTexture(int _imgIndex, int _frameIndex)
{
	...
	DebugAssertMsg(textureCacheMap_.Exist(resourceIndex.value_), "%s, 해당하는 프레임 데이터가 없습니다. [1]",
...
{
	DebugAssertMsg(textureCacheMap_.Exist(_sgaResourceIndex.value_), "%s, 해당하는 프레임 데이터가 없습니다. [2]",
