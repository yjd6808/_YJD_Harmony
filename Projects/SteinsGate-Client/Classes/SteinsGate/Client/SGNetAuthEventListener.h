...
#include <SteinsGate/Client/SGNetClientEventListener.h>

class SGNetAuthEventListener : public SGNetClientEventListener
{
public:
	SGNetAuthEventListener(SGCommandParser* parser);
