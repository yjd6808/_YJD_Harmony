...
AIInfo::AIInfo(const AIInfo& other) {
	Code = other.Code;
...
float AIInfo::getWanderProb(AIWanderDecision_t decision) {
...
float AIInfo::getTrackProb(AITrackDecision_t decision) {
...
float AIInfo::getAngryProb(AIAngryDecision_t decision) {
