...
static constexpr const char* Script = "select c_account_id, c_id, c_pass, c_created, c_created2, c_logined from t_account";
...
static constexpr const char* Script = "select c_account_id, c_created, c_created2, c_logined, c_last_server from t_account where c_id = ? and c_pass = ?";
