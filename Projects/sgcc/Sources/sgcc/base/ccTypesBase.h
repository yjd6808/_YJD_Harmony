 ...
 */
struct SGCC_DLL V2F_C4B_T2F_Triangle
{
    V2F_C4B_T2F a;
    V2F_C4B_T2F b;
    V2F_C4B_T2F c;
 ...
 */
struct SGCC_DLL V2F_C4B_T2F_Quad
{
    /// bottom left
    V2F_C4B_T2F    bl;
    /// bottom right
 ...
 */
struct SGCC_DLL V3F_C4B_T2F_Quad
{
    /// top left
    V3F_C4B_T2F    tl;
    /// bottom left
 ...
 */
struct SGCC_DLL V2F_C4F_T2F_Quad
{
    /// bottom left
    V2F_C4F_T2F    bl;
    /// bottom right
 ...
 */
enum class SGCC_DLL TextVAlignment
{
    TOP,
    CENTER,
    BOTTOM
 ...
 * @note If any of these enums are edited and/or reordered, update Texture2D.m.
 */
enum class SGCC_DLL TextHAlignment
{
    LEFT,
    CENTER,
    RIGHT
 ...
 */
struct SGCC_DLL AnimationFrameData
{
    T2F_Quad texCoords;
    float delay;
    Size size;
 ...
 * Font attributes.
 */
struct SGCC_DLL FontDefinition
{
public:
    /**
     * @js NA
