...
namespace SGToolsUI.Customize.Control
{
    public class UIElementPropertyGrid : PropertyGrid, IDataDragReceiver, IKeyboardInputReceiver
    {
        ...
        public new ContextMenu ContextMenu { get; private set; } = null!;
        public MenuItem ClearMenuItem { get; private set; } = null!;
        public PropertyItemsControl PropertyItemsControl { get; private set; } = null!;
        ...
        private string selectProperty_ = string.Empty;
