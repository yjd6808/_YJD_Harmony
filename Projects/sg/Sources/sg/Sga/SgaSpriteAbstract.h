...
#include "sg/Sga/SgaImage.h"
#include "sg/Sga/SgaCompressMode.h"
#include "sg/Sga/SgaSpriteRect.h"
...
public:
	...
	SgaSpriteAbstract(const SgaImagePtr& _pParent, Type _type, int _frameIndex, int _colorFormat)
	: m_spParent(_pParent)
	, m_eType(_type)
	, m_iFrameIndex(_frameIndex)
	, m_eColorFormat(_colorFormat)
	{
	}
...
public:
	...
	{
		return jc::StringUtil::Format("Sga(%s), Img(%s), Sprite(%d)",
