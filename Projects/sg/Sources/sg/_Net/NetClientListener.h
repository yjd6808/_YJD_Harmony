...
protected:
	...
	virtual void OnReceivedCmd(jnet::Session* _pSession, jnet::ICommand* _pRecvCmd) override;
	virtual void OnReceivedPacket(jnet::Session* _pSession, jnet::RecvedPacket* _pRecvPacket) override;
