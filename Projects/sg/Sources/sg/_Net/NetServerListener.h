...
protected:
	...
	virtual void OnDisconnected(jnet::Session* _pDisconnectedSession, Int32U _errorCode) override;
	virtual void OnSent(jnet::Session* _pSender, jnet::IPacket* _pSentPacket, Int32UL _sentBytes) override;
