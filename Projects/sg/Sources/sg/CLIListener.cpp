...
//////////////////////////////////////////////////////////////////////////////////////////
bool CLIListener::CLI_HelpBase(int /*_argc*/, jc::String* /*_pArgv*/)
{
...
//////////////////////////////////////////////////////////////////////////////////////////
bool CLIListener::CLI_SendCommandFilter(int _argc, String* _pArgv)
{
	if (_argc <= 1)
	{
	...
	if (_pArgv[1] == "add")
	{
		...
		g_cConfigRuntime.FilterCommand(jnet::Transmission::Send, commandId);
	...
	else if (_pArgv[1] == "remove")
	{
		...
		g_cConfigRuntime.UnfilterCommand(jnet::Transmission::Send, commandId);
		Console::WriteLine("송신 커맨드 필터에서 %d커맨드 제거완료", commandId);
	}
	else if (_pArgv[1] == "show")
	{
		g_cConfigRuntime.ShowCommandFilter(jnet::Transmission::Send);
	}
	else
	{
...
//////////////////////////////////////////////////////////////////////////////////////////
bool CLIListener::CLI_RecvCommandFilter(int _argc, String* _pArgv)
{
	if (_argc <= 1)
	{
		Console::WriteLine("인자 갯수가 올바르지 않습니다.");
	...
	if (_pArgv[1] == "add")
	{
		...
		g_cConfigRuntime.FilterCommand(jnet::Transmission::Recv, commandId);
	...
	else if (_pArgv[1] == "remove")
	{
		...
		g_cConfigRuntime.UnfilterCommand(jnet::Transmission::Recv, commandId);
		Console::WriteLine("수신 커맨드 필터에서 %d커맨드 제거완료", commandId);
	}
	else if (_pArgv[1] == "show")
	{
		g_cConfigRuntime.ShowCommandFilter(jnet::Transmission::Recv);
	}
	else
	{
		Console::WriteLine("올바르지 않은 명령입니다.");
...
//////////////////////////////////////////////////////////////////////////////////////////
bool CLIListener::CLI_ShowSendCommand(int _argc, String* _pArgv)
{
	if (_argc <= 1)
	{
		Console::WriteLine("인자 갯수가 올바르지 않습니다.");
	...
	g_cConfigRuntime.showSendCommand_ = enable;
...
//////////////////////////////////////////////////////////////////////////////////////////
bool CLIListener::CLI_ShowRecvCommand(int _argc, String* _pArgv)
{
	if (_argc <= 1)
	{
		Console::WriteLine("인자 갯수가 올바르지 않습니다.");
	...
	g_cConfigRuntime.showRecvCommand_ = enable;
...
//////////////////////////////////////////////////////////////////////////////////////////
bool CLIListener::CLI_ShowSendPacketHex(int _argc, String* _pArgv)
{
	if (_argc <= 1)
	{
		Console::WriteLine("인자 갯수가 올바르지 않습니다.");
	...
	g_cConfigRuntime.showSendPacketHex_ = enable;
...
//////////////////////////////////////////////////////////////////////////////////////////
bool CLIListener::CLI_ShowRecvPacketHex(int _argc, String* _pArgv)
{
	if (_argc <= 1)
	{
		Console::WriteLine("인자 갯수가 올바르지 않습니다.");
	...
	g_cConfigRuntime.showRecvPacketHex_ = enable;
...
//////////////////////////////////////////////////////////////////////////////////////////
bool CLIListener::CLI_ConsoleLog(int _argc, jc::String* _pArgv)
{
	if (_argc <= 3)
	{
		Console::WriteLine("인자 갯수가 올바르지 않습니다.");
	...
	if (_pArgv[2] == "enable")
	{
		...
		g_cConfigRuntime.showConsoleLog_[logLevel] = enable;
		g_cConfigRuntime.ApplyLoggerOption();
		return false;
	}
	...
	if (_pArgv[2] == "color")
	{
		...
		g_cConfigRuntime.consoleLogColor_[logLevel] = consoleColor;
		g_cConfigRuntime.ApplyLoggerOption();
		return false;
	}
...
//////////////////////////////////////////////////////////////////////////////////////////
bool CLIListener::CLI_ConsoleNetLog(int _argc, String* _pArgv)
{
	if (_argc <= 3)
	{
		Console::WriteLine("인자 갯수가 올바르지 않습니다.");
	...
	if (_pArgv[2] == "enable")
	{
		...
		g_cConfigRuntime.showConsoleNetLog_[logLevel] = enable;
		g_cConfigRuntime.ApplyNetLoggerOption();
		return false;
	}
	...
	if (_pArgv[2] == "color")
	{
		...
		g_cConfigRuntime.consoleNetLogColor_[logLevel] = consoleColor;
		g_cConfigRuntime.ApplyNetLoggerOption();
		return false;
	}
...
//////////////////////////////////////////////////////////////////////////////////////////
bool CLIListener::CLI_ConfigRuntime(int _argc, String* _pArgv)
{
	if (_argc <= 1)
	{
		Console::WriteLine("인자 갯수가 올바르지 않습니다.");
	...
	if (_pArgv[1] == "save")
	{
		g_cConfigRuntime.Save();
		return false;
	}

	if (_pArgv[1] == "delete")
	{
		g_cConfigRuntime.Delete();
		return false;
	}
...
//////////////////////////////////////////////////////////////////////////////////////////
LoggerAbstract::Level CLIListener::ConvertLogLevel(const jc::String& _logLevelString)
{
