 ...
 * 수정일: 8/16/2026 (AutoIncrementLinkedList → IdProviderReuse 개명: 2026-08-16)
 * =====================
...
class IdProviderReuse final : public IIdProvider<TKey>
{
...
public:
	...
	~IdProviderReuse() override = default;
