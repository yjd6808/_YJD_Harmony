...
struct CRuntime {
	 ...
	 * 
	 */
	static size_t JCORE_CDECL FileWrite(const void* _pBuffer, size_t _size, size_t _count, IoHandle _pStream);
	 ...
	 * \return 읽은 원소 갯수
	 */
	static size_t JCORE_CDECL FileRead(void* _pBuffer, size_t _size, size_t _count, IoHandle _pStream);
