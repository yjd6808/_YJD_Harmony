...
public:
	...
	// 검색 & 찾기 연산
	//////////////////////////////////////////////////////////////////////////////////////////
	_s32 Find(const char* _pStr) const;
	_s32 Find(const StringView& _str) const;
	_s32 Find(const String& _str) const;
	_s32 Find(_s32 _startIndex, const char* _pStr) const;
	_s32 Find(_s32 _startIndex, const StringView& _str) const;
	_s32 Find(_s32 _startIndex, const String& _str) const;
	_s32 Find(_s32 _startIndex, _s32 _endIndex, const char* _pStr) const;

	_s32 FindReverse(const char* _pStr) const;
	_s32 FindReverse(const StringView& _str) const;
	_s32 FindReverse(const String& _str) const;
	_s32 FindReverse(_s32 _startIndex, _s32 _endIndex, const char* _pStr) const;

	//////////////////////////////////////////////////////////////////////////////////////////
	// 패턴 매칭 & 문자열 내용
	//////////////////////////////////////////////////////////////////////////////////////////
	bool StartWith(const StringView& _str) const;
	bool StartWith(const String& _str) const;

	bool EndWith(const StringView& _str) const;
	bool EndWith(const String& _str) const;

	bool Contain(const char* _str) const;
	bool Contain(const StringView& _str) const;
	bool Contain(const String& _str) const;

	//////////////////////////////////////////////////////////////////////////////////////////
	// 개수 세기 연산
	//////////////////////////////////////////////////////////////////////////////////////////
	_s32 Count(const char* _pStr) const;
	_s32 Count(const StringView& _value) const;
	_s32 Count(const String& _value) const;
	_s32 Count(_s32 _startIndex, _s32 _endIndex, const char* _pStr) const;
	_s32 Count(_s32 _startIndex, _s32 _endIndex, const StringView& _value) const;
	_s32 Count(_s32 _startIndex, _s32 _endIndex, const String& _value) const;
