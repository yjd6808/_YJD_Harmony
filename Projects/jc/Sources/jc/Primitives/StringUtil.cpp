...
// ========================================================================================
// ToStringBuffered 특수화
// ========================================================================================

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, bool _value)
{
	return snprintf(_pBuff, _capacity, "%s", _value ? "true" : "false");
}

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, _s8 _value)
{
	return snprintf(_pBuff, _capacity, "%d", static_cast<_s32>(_value));
}

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, _u8 _value)
{
	return snprintf(_pBuff, _capacity, "%u", static_cast<_u32>(_value));
}

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, _s16 _value)
{
	return snprintf(_pBuff, _capacity, "%d", static_cast<_s32>(_value));
}

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, _u16 _value)
{
	return snprintf(_pBuff, _capacity, "%u", static_cast<_u32>(_value));
}

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, _s32 _value)
{
	return snprintf(_pBuff, _capacity, "%d", _value);
}

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, _u32 _value)
{
	return snprintf(_pBuff, _capacity, "%u", _value);
}

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, _s32l _value)
{
	return snprintf(_pBuff, _capacity, "%ld", _value);
}

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, _u32l _value)
{
	return snprintf(_pBuff, _capacity, "%lu", _value);
}

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, _s64 _value)
{
	return snprintf(_pBuff, _capacity, "%lld", _value);
}

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, _u64 _value)
{
	return snprintf(_pBuff, _capacity, "%llu", _value);
}

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, float _value)
{
	return snprintf(_pBuff, _capacity, "%g", _value);
}

//////////////////////////////////////////////////////////////////////////////////////////
template <> int StringUtil::ToStringBuffered(char* _pBuff, int _capacity, double _value)
{
	return snprintf(_pBuff, _capacity, "%g", _value);
}
...
{
	char buf[8];
	ToStringBuffered(buf, sizeof(buf), _value);
	return buf;
}
