...
{
    return StringUtilA::ToStringBuffered(_pBuff, _capacity, _value);
}
...
{
    return StringUtilA::Find(_pSource, _sourceLen, _startIdx, _endIdx, _pStr, _strLen, _caseSensitive != 0);
}

//////////////////////////////////////////////////////////////////////////////////////////
_s32 StringUtil_FindFrom(const _s8* _pSource, _s32 _sourceLen, _s32 _startIdx, const _s8* _pStr, _s32 _caseSensitive)
{
    return StringUtilA::Find(_pSource, _sourceLen, _startIdx, _pStr, _caseSensitive != 0);
}

//////////////////////////////////////////////////////////////////////////////////////////
_s32 StringUtil_FindAll(_s32* _pPositionArray, const _s8* _pSource, const _s8* _pStr, _s32 _caseSensitive)
{
    return StringUtilA::FindAll(_pPositionArray, _pSource, _pStr, _caseSensitive != 0);
}

//////////////////////////////////////////////////////////////////////////////////////////
_s32 StringUtil_FindAllLen(_s32* _pPositionArray, const _s8* _pSource, _s32 _sourceLen, const _s8* _pStr, _s32 _caseSensitive)
{
    return StringUtilA::FindAll(_pPositionArray, _pSource, _sourceLen, _pStr, _caseSensitive != 0);
}
...
{
    return StringUtilA::FindAll(_pPositionArray, _pSource, _sourceLen, _startIdx, _endIdx, _pStr, _caseSensitive != 0);
}

//////////////////////////////////////////////////////////////////////////////////////////
_s32 StringUtil_FindChar(const _s8* _pSource, _s8 _ch)
{
    return StringUtilA::FindChar(_pSource, _ch);
}

//////////////////////////////////////////////////////////////////////////////////////////
_s32 StringUtil_FindCharReverse(const _s8* _pSource, _s8 _ch)
{
    return StringUtilA::FindCharReverse(_pSource, _ch);
}

//////////////////////////////////////////////////////////////////////////////////////////
_s32 StringUtil_FindCharReverseLen(const _s8* _pSource, _s32 _len, _s8 _ch)
{
    return StringUtilA::FindCharReverse(_pSource, _len, _ch);
}

//////////////////////////////////////////////////////////////////////////////////////////
_s32 StringUtil_FindCharUncontained(const _s8* _pSource, _s8 _ch)
{
    return StringUtilA::FindCharUncontained(_pSource, _ch);
}

//////////////////////////////////////////////////////////////////////////////////////////
_s32 StringUtil_Compare(const _s8* _pStr1, const _s8* _pStr2)
{
    return StringUtilA::Compare(_pStr1, _pStr2);
}

//////////////////////////////////////////////////////////////////////////////////////////
_s32 StringUtil_CompareLen(const _s8* _pStr1, _s32 _str1Len, const _s8* _pStr2, _s32 _str2Len)
{
    return StringUtilA::Compare(_pStr1, _str1Len, _pStr2, _str2Len);
}
