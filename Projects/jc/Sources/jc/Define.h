	...
	#define JC_LEAK_CHECK_ASSERT		jc::AutoMemoryLeakDetector JC_CONCAT_COUNTER(_) {[](_u32 leakedBytes ) { jc_assert_msg(leakedBytes == 0, _T("%u 바이트 메모리 릭이 있습니다."), leakedBytes); }}
	...
	#define JC_SENUM_BEGIN_2(enum_name, type) struct enum_name { enum_name() = delete; enum _ : type {
