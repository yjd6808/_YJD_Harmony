...
void ListenerChatServer::OnSent(Session* sender, ISendPacket* sentPacket, Int32UL sentBytes) {
...
void ListenerChatServer::OnReceived(Session* session, IRecvPacket* recvPacket) {
