...
#include <sgtc/_Scene/Scene_Game.h>
#include <sgtc/_Layer/Layer_Game.h>
...
SceneBase* WorldScene::CreateScene(SceneType_t _sceneType)
{
	...
	switch (_sceneType)
	{
	case SceneType::Game: pCreatedScene = GameScene::create();
		break;
