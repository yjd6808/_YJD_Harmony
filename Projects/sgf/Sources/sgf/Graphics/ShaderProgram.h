...
public:
	...
	// HLSL 파일을 읽어서 컴파일한다.
	bool InitializeFromFile(GraphicDevice& _device, const jc::String& _szFilePath, const jc::String& _szEntry = _T("VSMain"));
...
public:
	...
	bool InitializeFromSource(GraphicDevice& _device, const jc::String& _szSource, const jc::String& _szEntry = _T("PSMain"));
	bool InitializeFromFile(GraphicDevice& _device, const jc::String& _szFilePath, const jc::String& _szEntry = _T("PSMain"));
