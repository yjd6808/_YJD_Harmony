...
struct ComboTreeNode
{
	ComboActionPtr Action{};
...
public:
	...
	void RemoveAll();
	void AddComboAction(const ComboActionPtr& action);
	void AddComboAction(ComboActionPtr&& action);
	ComboActionPtr GetComboAction(const ComboKeyList& keys);
private:
