...
//////////////////////////////////////////////////////////////////////////////////////////
jnet::TcpSession* CenterServer::CreateSession()
{
...
{
	const Vector<int>& activeServerIdList = sg::ServerProcessInfoPackage->activeServerIdList_;
