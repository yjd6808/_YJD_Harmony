...
void CommonServer::OnStarted()
{
	...
	S_SETUP_IS_COMMON::SetInformation(sg::InterServerClientTcp, SendStrategy::SendAsync);
	S_SETUP_IS_COMMON::SEND_SCE_NotifyBootState(sg::ServerProcessInfo->serverId_, serverType,
...
void CommonServer::OnStartFailed(Int32U _errorCode)
{
	...
	bootState_ = ServerBootState::Stopped;
	S_SETUP_IS_COMMON::SetInformation(sg::InterServerClientTcp, SendStrategy::SendAsync);
	S_SETUP_IS_COMMON::SEND_SCE_NotifyOrderFailed(sg::ServerProcessInfo->serverId_, serverType,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void CommonServer::OnUpdate(const jc::TimeSpan& _elapsed)
{
	(void)_elapsed;
}
