...
constexpr jc::Range AuthHandleRange = { SeqUnit * 1, SeqUnit * 2 }; // 100000 ~ 200000
constexpr jc::Range LobbyHandleRange = { SeqUnit * 2, SeqUnit * 3 }; // 200000 ~ 300000
constexpr jc::Range LogicHandleRange = { SeqUnit * 3, SeqUnit * 4 }; // 300000 ~ 400000
constexpr jc::Range AreaHandleRange = { SeqUnit * 4, SeqUnit * 5 }; // 400000 ~ 500000
constexpr jc::Range ChatHandleRange = { SeqUnit * 5, SeqUnit * 6 }; // 500000 ~ 600000
constexpr jc::Range CenterHandleRange = { SeqUnit * 6, SeqUnit * 7 }; // 600000 ~ 700000
}
