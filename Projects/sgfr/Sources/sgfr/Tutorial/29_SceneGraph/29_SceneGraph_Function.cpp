...
bool CreateCircleTexture(GraphicDevice& _device, Texture* _pOutTexture, _s32 _size, const color& _color)
{
	...
	return _pOutTexture->CreateFromMemory(_device, pixels.Source(), _size, _size);
}
