...
void Cube3D_Main()
{
	...
	const VertexPC vertices[] = {
		{ vec3(-0.5f, +0.5f, -0.5f), color(0xFF, 0x00, 0x00, 0xFF) },	// 0: 앞-왼위
		{ vec3(+0.5f, +0.5f, -0.5f), color(0x00, 0xFF, 0x00, 0xFF) },	// 1: 앞-오른위
		{ vec3(-0.5f, -0.5f, -0.5f), color(0x00, 0x00, 0xFF, 0xFF) },	// 2: 앞-왼아래
		{ vec3(+0.5f, -0.5f, -0.5f), color(0xFF, 0xFF, 0x00, 0xFF) },	// 3: 앞-오른아래
		{ vec3(-0.5f, +0.5f, +0.5f), color(0xFF, 0x00, 0xFF, 0xFF) },	// 4: 뒤-왼위
		{ vec3(+0.5f, +0.5f, +0.5f), color(0x00, 0xFF, 0xFF, 0xFF) },	// 5: 뒤-오른위
		{ vec3(-0.5f, -0.5f, +0.5f), color(0xFF, 0xFF, 0xFF, 0xFF) },	// 6: 뒤-왼아래
		{ vec3(+0.5f, -0.5f, +0.5f), color(0x4D, 0x4D, 0x4D, 0xFF) },	// 7: 뒤-오른아래
	};
